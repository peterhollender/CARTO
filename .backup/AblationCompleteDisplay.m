...
resFileDataPath_Pre = '/getlab/pjh7/SC2000/data/20130219_RA_PreAblation/res/Pesavento';
...
UserMapIndex_Pre = load(fullfile(resFileDataPath_Pre,'CartoMapIndexData.mat'));
CARTO_Post = processCartoStudy(CartoXMLfile,resFileDataPath_Post,UserMapIndex_Post);
CARTO_Pre = processCartoStudy(CartoXMLfile,resFileDataPath_Pre,UserMapIndex_Pre);
%%
%CARTO_Post.UserMapIndex.ResIndices = 1:2:24;
%CARTO_Pre.UserMapIndex.ResIndices = 1:2:20;
Depths = [0:0.02:0.25];
